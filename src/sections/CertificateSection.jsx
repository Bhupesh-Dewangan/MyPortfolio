...
const CertificateSection = () => {
  ...
  return (
    <section className="py-16 px-4 md:px-8 bg-linear-to-br from-gray-900 via-black to-gray-900 text-white">
      ...
      <div className="text-center mt-12">
        <button className="px-6 py-3 rounded-full font-bold bg-white text-black hover:bg-gray-300 transition">
